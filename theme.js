...
(function () {
  ...
  function installBrandStyles() {
    ...
    link.rel = 'stylesheet';
    link.href = 'brand.css?v=1.0.0-wireframe1';
    link.dataset.synapBrand = 'wireframe1';
  ...
  function apply() {
    ...
    document.querySelector('meta[name="theme-color"]')?.setAttribute('content', mode === 'dark' ? '#07172f' : '#f7f9fd');
  ...
  function installAISettings() {
    ...
    if (tokenLabel) { tokenLabel.id = 'apiKeyLabel'; tokenLabel.textContent = 'OpenAI API key'; }
    token.placeholder = 'sk-…'; token.autocomplete = 'off';
