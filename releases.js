/* Public release feed for device-ID OTA. Hashes are integrity checks, not signatures. */
(function(root){
  'use strict';
  ...
  function validateManifest(m) {
    if(!m||m.schema!==1||m.target!==TARGET||m.protocol!==3||m.chip!==9||m.partition!=='default'||
  ...
  root.SynapReleases={TARGET,BASE,IDENTITY_UUID,validateManifest,compatible,latest,download};
