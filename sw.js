...
/* Battery listener is now installed synchronously before BLE characteristic listeners. */
const CACHE_REVISION='1.0.0-shell10-battery-sync';
...
const APP_SHELL=[
  ...
  './touch-event-bridge.js','./battery-ble-fix.js','./battery-popover-fix.js','./memory-ui-fix.js','./device-identity.js','./audio-store.js','./ota.js','./releases.js',
