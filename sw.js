...
const APP_SHELL = [
  ENTRY_PATH, "./device-identity.js?v=1.0.0-device1", "./ota.js?v=1.0.0-ota2", "./releases.js?v=1.0.0-ota2", "./styles.css?v=1.0.0-device1", "./audio-store.js?v=1.0.0-device1", "./app.js?v=1.0.0-device1",
