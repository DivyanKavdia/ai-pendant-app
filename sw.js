...
const APP_SHELL = [
  ENTRY_PATH, "./device-identity.js?v=1.0.0-device1", "./ota.js?v=1.0.0-timeline1", "./releases.js?v=1.0.0-idota1", "./styles.css?v=1.0.0-timeline1", "./audio-store.js?v=1.0.0-device1", "./app.js?v=1.0.0-timeline1",
