/* Release 5.5.1. Only this application's public shell is cached. */
const APP_VERSION = "5.5.1";
const ENTRY_PATH = "./index.html?v=" + APP_VERSION;
const CACHE_NAME = "dk-pendant-pwa-v" + APP_VERSION;
const APP_SHELL = [
  ENTRY_PATH, "./styles.css?v=5.5.1", "./audio-store.js?v=5.5.1", "./app.js?v=5.5.1",
  "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./logo.webp?v=5.5.1"
];
